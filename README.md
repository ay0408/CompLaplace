...
← How "sufficiently" far apart must they be to enable employing different mechanisms to different groups? / What should noise in such mechanisms look like?
